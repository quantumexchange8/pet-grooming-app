  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dogs', style: heading4Bold),
        centerTitle: true,
        actions: [
          Padding(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(dog.dogName, style: bodyLSemibold),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(dog.distanceDog, style: bodyXSRegular),
                                      const SizedBox(width: 8),
                                      Text('·', style: bodyXSRegular),
                                      const SizedBox(width: 8),
                                      Flexible(
                                        child: Text(dog.dogBreed, style: bodyXSRegular,overflow: TextOverflow.ellipsis, maxLines: 1)
                                      ),
                                    ],
                                  ),
                                ],
